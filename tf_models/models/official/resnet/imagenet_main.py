...
def input_fn(is_training, data_dir, batch_size, num_epochs=1,
             num_parallel_calls=1, multi_gpu=False, numworkers=1, workerid=0):
  ...
  # when eval we will break up the full dataset across processes
  #if not is_training:
  ...
  return resnet_run_loop.process_record_dataset(
      ...
      multi_gpu=multi_gpu,numworkers=numworkers)
...
def imagenet_model_fn(features, labels, mode, params):
  ...
  learning_rate_fn = resnet_run_loop.learning_rate_warmup_poly_decay(
       ...
       learning_rate_0=0.1, learning_rate_base=40., decay_epochs=188, warmup_epochs=12, mlcomm=params['mlcomm'])
  # END CRAY MODIFIED
...
def main(argv):
  ...
  resnet_run_loop.resnet_main(
      flags, imagenet_model_fn, input_function, _NUM_IMAGES['train'], _NUM_IMAGES['validation'],
